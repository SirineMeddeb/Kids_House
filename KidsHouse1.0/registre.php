...
<body> 
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li><a href="#" class="dropdown-toggle link link--yaku" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>Notre Pédagogie <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="icons.html" class="link link--yaku"><span>Programme éducatif</a></li>
								<li><a href="codes.html" class="link link--yaku"><span>Journée Type</span></a></li>
						...
						<li><a href="connexion.html" class="link link--yaku"><span>Connexion</span></a></li>
					</ul>		
	...
	<!-- Login -->
		...
		<div class="container">
			<h3 class="agileits-title1">Enregistrement</h3>  
			<div class="contact-w3lsrow">
				...
				<form action="registre_account.php" method="post">
						Nom <input type="text" name="nom" placeholder="Votre Nom" required="">
						Prénom <input type="text" name="prenom" placeholder="Votre Prénom" required="">
						e-mail  <input type="text" name="mail" placeholder="xxx@yyy.com" required="">
						Login <input type="text" name="login" placeholder="Login" required="">
						Password <input type="text" name="password" placeholder="*****" required="">
