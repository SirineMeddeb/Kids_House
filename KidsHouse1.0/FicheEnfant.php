...
<body> 
	...
	<!-- Login -->
		...
		<div class="container">
			<h3 class="agileits-title1">Ajouter un enfant</h3>  
			<div class="contact-w3lsrow">
				...
				<form action="" method="post">
						<table>
						<tr>
							<td>Nom <input type="text" name="nom" placeholder="Nom" required=""></td>
							<td></td>
							<td>Prénom <input type="text" name="prenom" placeholder="Prénom" required=""></td>
						</tr>
						<tr>
							<td>Date de Naissance <input type="date" name="nom" placeholder="Nom" required="" class="date"></td>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td>sex <input type="text" name="prenom" placeholder="Prénom" required=""></td>
						</tr>
						<tr>
						<td>
					 ...
					 <h2 class="agileits-title1"><a href="registre.php">Créer un compte</a></h2> 
				</div>
